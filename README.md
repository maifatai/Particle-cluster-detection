...
### One-stage model
  ...
  | Swin-L-YOLOX  | 55.6 |87.1|65.5|15.64| 246.56| 69.52 | [github](https://github.com/maifatai/Particle-cluster-detection/releases/download/v1.0.0/swin_l_yolox.pth)|
...
### Two-stage model
  ...
  |  ConvNeXt-L-RCNN  | 68.0 |93.4|86.2 |10.04| 213.74|65.61 | [github](https://github.com/maifatai/Particle-cluster-detection/releases/download/v1.0.0/convnext_l_rcnn.zip.001) [github](https://github.com/maifatai/Particle-cluster-detection/releases/download/v1.0.0/convnext_l_rcnn.zip.002) |
