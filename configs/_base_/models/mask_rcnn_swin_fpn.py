...
model = dict(
    ...
    backbone=dict(#对应mmdet/models/backbones/文件夹中的文件
        type='SwinTransformer',#对应mmdet/models/backbones/swim_transformer.py的SwinTransformer类
        embed_dim=96,#SwinTransformer 类的输入
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
        window_size=7,
        mlp_ratio=4.,
    ...
    roi_head=dict(#对应mmdet/models/roi_head/文件夹中的文件
        ...
        #         use_mask=False,# CrossEntropyLoss类的输入
        #         loss_weight=1.0))
