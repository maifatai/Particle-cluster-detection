...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/mask_rcnn_convnext_s_patch4_window7_mstrain_480-800_adamw_3x_coco_in1k/latest.pth'
workflow = [('train', 1)]
max_epochs = 10000
work_dir = './work_dirs/mask_rcnn_convnext_s_patch4_window7_mstrain_480-800_adamw_3x_coco_in1k'
gpu_ids = range(0, 1)
